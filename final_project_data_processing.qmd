...
).properties(title='Violence Over Time',width=600, height=400)
...
).properties(title='Birth Rates Over Time',width=600, height=400)
...
).properties(title='Under 5 Deaths Over Time',width=600, height=400)
...
).properties(title='Debt Payments Over Time',width=600, height=400)
...
# graph
edu_ch = alt.Chart(violence_edu_df).mark_line(color='cyan').encode(
    x=alt.X('Year:O', title='Year'),
    y=alt.Y('Primary education, pupils:Q', axis=alt.Axis(title='Total number of Students', labelColor='cyan'), scale=alt.Scale(domain=[5800000, 6100000])),
    tooltip=['Year', 'Primary education, pupils']
).properties(title='Education over time',width=600, height=400)
